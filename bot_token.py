...
db_config = {
    'host': 'TselSikka.mysql.pythonanywhere-services.com',
    'user': 'TselSikka',  # Ganti dengan username Anda
    'password': 'BranchSikka97',  # Ganti dengan password Anda
    'database': 'TselSikka$Token_Flotim',  # Nama database Anda
}
...
def create_connection():
    try:
        ...
        connection = mysql.connector.connect(
            host='TselSikka.mysql.pythonanywhere-services.com',  # Ganti dengan username Anda
            user='TselSikka',  # Ganti dengan username Anda
            password='BranchSikka97',  # Ganti dengan password database Anda
            database='TselSikka$Token_Flotim'  # Ganti dengan nama database Anda
        )
...
app = ApplicationBuilder().token('8016413245:AAGtPh_irrOB0WAdULztMaz2B9NVK3musNA').build()
